...
const MapPreview = (props) => {
  let imagePreviewUrl;
  if (props.location) {
    // add a valid googleKeyApi to (env.js) before using this link
    ...
    // dummy link for preview
    imagePreviewUrl =
      "https://storage.googleapis.com/gweb-cloudblog-publish/images/MapImage1.max-600x600.png";
  }
  return (
    <TouchableOpacity
